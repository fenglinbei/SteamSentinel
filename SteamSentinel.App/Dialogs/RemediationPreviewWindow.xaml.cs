...
public partial class RemediationPreviewWindow : Window
{
    public RemediationPreviewWindow(RemediationPlan plan, IReadOnlyList<string>? notes = null)
    {
        ...
        GroupedActions.GroupDescriptions.Add(new PropertyGroupDescription(nameof(RemediationActionDisplayItem.Group)));
        DataContext = this;
    }
    ...
    public string Summary { get; } = "请核对下面的实际动作，未纳入项不会执行。";
